...
const hostname = 'https://www.bonus-casino-enligne.fr'; // Nouvel hostname
...
const sitemapPath = path.join(__dirname, 'build', 'sitemap_fr.xml'); // Nouveau chemin pour sitemap_fr.xml
